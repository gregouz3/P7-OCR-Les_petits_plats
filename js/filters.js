...
const filterRecipesWithPrincipaleSearchBar = (element, recipe, filteredRecipes) => {
    if (
...
const selectRecipe = () => {
  ...
  export default {
    filterRecipesWithPrincipaleSearchBar,
    filterIngredientsInSearchBar,
    filterAppareilsInSearchBar,
    filterUstensilsInSearchBar,
